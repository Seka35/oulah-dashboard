...
class MetaAPI:
    ...
    def __init__(self, max_retries=3):
        ...
        self.act_id = f"act_{self.account_id}" if not Config.META_AD_ACCOUNT_ID.startswith("act_") else Config.META_AD_ACCOUNT_ID
        self.page_id = os.getenv("META_PAGE_ID", "313292755401170")
